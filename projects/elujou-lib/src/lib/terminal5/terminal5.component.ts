...
import { GraafMudelDataComponent } from '../graafMudelData/graafMudelData.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, XteechangeComponent, GraafMudelToojoudComponent, GraafMudelDataComponent]
})
